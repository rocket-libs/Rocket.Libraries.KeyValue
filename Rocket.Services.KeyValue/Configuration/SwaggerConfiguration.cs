...
namespace Rocket.Services.KeyValue.Configuration
{
    ...
    {
        private const string APITitle = "Rocket.Services.KeyValue API";
        ...
        {
            var notices = $"<span style='color:#b0178a; margin-top:20px'><i><b>Important:</b> Unless explicitly stated otherwise: <ol>{OptionalNotice}</ol></i></span>";
